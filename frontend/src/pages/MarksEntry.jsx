    ...
    <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="min-h-screen md:ml-64 flex pt-16 px-4">
      ...
      <div className="bg-white rounded-xl shadow p-4 md:p-6 mb-6 ">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-4">
          ...
          />
          <button type="button" onClick={handleCreateExam} className="btn-primary flex items-center gap-2 px-4 py-2 rounded-lg bg-purple-600 text-white font-semibold hover:bg-purple-700 transition self-start">
                  ...
                  <div className="mt-2 mb-4">
                    ...
                    {note.subjects.length > 0 ? (
                      <div className="overflow-x-auto">
                        <table className="w-full text-left border border-purple-100 rounded-lg mb-2 min-w-[400px]">
                          <thead>
